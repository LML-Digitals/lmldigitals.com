      ...
      <div className="flex flex-col lg:flex-row justify-center items-center gap-8 lg:gap-32">
        <div className="flex flex-col gap-4 w-full lg:w-1/3 px-4 lg:px-0">
          ...
          <p className="text-sm md:text-base">
            ...
            This leads our thinking from the very start to ensure we&apos;re
            delivering work that not only provides growth but future-proofs your
            brand as the digital industry continues to progress rapidly. If
            you&apos;re looking for a partner just to tick boxes, then we
            aren&apos;t the ones for you. But if you want a partner who&apos;ll
            push you, be innovative, and level up everything you do, then we
